...
abstract class FlutterFlowTheme {
  ...
  late Color navigationButtonColor;
  late Color buttonUnseletedcolor;
  late Color aoaColor;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF081C30);
  late Color secondary = const Color(0xFFB1B3B0);
  ...
  late Color secondaryBackground = const Color(0xFFF3EFEE);
  late Color accent1 = const Color(0xFF081C30);
  ...
  late Color navigationButtonColor = const Color(0xFF081C30);
  late Color buttonUnseletedcolor = const Color(0xFF576778);
  late Color aoaColor = const Color(0xFF081C30);
}
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF081C30);
  late Color secondary = const Color(0xFFF3EFEE);
  late Color tertiary = const Color(0xFF081C30);
  late Color alternate = const Color(0xFFF3EFEE);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFF9F9F9);
  late Color primaryBackground = const Color(0xFF0A0A0A);
  late Color secondaryBackground = const Color(0xFF081C30);
  late Color accent1 = const Color(0xFF081C30);
  late Color accent2 = const Color(0xFFF9F9F9);
  late Color accent3 = const Color(0xFF081C30);
  late Color accent4 = const Color(0xFFFFF8F8);
  late Color success = const Color(0xFF04A24C);
  late Color warning = const Color(0x4DFF5963);
  late Color error = const Color(0xFFFF5963);
  late Color info = const Color(0xFFF3EFEE);

  late Color navigationButtonColor = const Color(0xFFFEFFFF);
  late Color buttonUnseletedcolor = const Color(0xFF576778);
  late Color aoaColor = const Color(0xFFFEFFFF);
}
