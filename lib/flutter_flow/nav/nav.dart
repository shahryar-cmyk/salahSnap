...
class AppStateNotifier extends ChangeNotifier {
  ...
  SalahSnapVersionSecondAuthUser? initialUser;
  SalahSnapVersionSecondAuthUser? user;
  ...
  void update(SalahSnapVersionSecondAuthUser newUser) {
    final shouldUpdate =
      ...
      routes: [
        FFRoute(
          ...
          routes: [
            ...
            FFRoute(
              name: OpenCameraPageWidget.routeName,
              path: OpenCameraPageWidget.routePath,
              builder: (context, params) => OpenCameraPageWidget(),
            ),
            FFRoute(
