...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    salahSnapVersionSecondAuthUserSubject.add(
      SalahSnapVersionSecondAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<SalahSnapVersionSecondAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  SalahSnapVersionSecondAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = SalahSnapVersionSecondAuthUser(
      loggedIn: true,
      uid: authUid,
    );
    salahSnapVersionSecondAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
SalahSnapVersionSecondAuthUser? currentUser;
